...
//     mutationFn: async () => {
//       if (editando) {
//         await atualizarJovem(editando.id, nome.trim(), patrulha.trim(), registroUeb.trim());
//       } else {
//         // Garantindo envio com perfil de ESCOTEIRO e registro UEB
//         await criarJovem({
//           nome: nome.trim(),
//           patrulha: patrulha.trim(),
//           registro_ueb: registroUeb.trim(),
//           email: email.trim(),
//           perfil: "ESCOTEIRO",
//         });
//       }
//     },
//     onSuccess: () => {
//       toast.success(editando ? "Jovem atualizado!" : "Jovem cadastrado com sucesso!");
//       setDialogOpen(false);
//       setEditando(null);
//       setNome("");
//       setPatrulha("");
...
//                   <p className="truncate text-sm font-semibold">{j.nome}</p>
//                   <p className="truncate text-xs text-muted-foreground">
//                     {j.patrulha ?? "Sem patrulha"} {j.registro_ueb ? `• UEB: ${j.registro_ueb}` : ""}
//                   </p>
//                 </div>
//                 <div className="flex shrink-0 gap-1">
//                   <Button
...
//             <div className="space-y-2">
//               <Label htmlFor="registro-ueb">Registro UEB</Label>
//               <Input
//                 id="registro-ueb"
//                 value={registroUeb}
...
//             <div className="space-y-2">
//               <Label htmlFor="email-jovem">E-mail de Acesso (opcional)</Label>
//               <Input
//                 id="email-jovem"
//                 type="email"
//                 value={email}
//                 onChange={(e) => setEmail(e.target.value)}
//                 placeholder="Ex.: ana.souza@exemplo.com"
//               />
//             </div>
...
// Defina aqui as patrulhas pré-definias da sua tropa
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              if (nome.trim() && email.trim() && patrulha) salvar.mutate();
            }}
          >
            <div className="space-y-2">
              <Label htmlFor="nome-jovem">Nome completo</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="registro-ueb">Registro UEB (opcional)</Label>
              <Input
                id="registro-ueb"
                value={registroUeb}
                onChange={(e) => setRegistroUeb(e.target.value)}
            ...
            <div className="space-y-2">
              <Label htmlFor="email-jovem">E-mail de Acesso</Label>
              <Input
                id="email-jovem"
                type="email"
                value={email}
            ...
            <div className="space-y-2">
              <Label htmlFor="patrulha-jovem">Patrulha</Label>
              <select
                id="patrulha-jovem"
                value={patrulha}
                onChange={(e) => setPatrulha(e.target.value)}
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button type="submit" disabled={!nome.trim() || !email.trim() || !patrulha || salvar.isPending}>
                {salvar.isPending ? "Salvando…" : "Salvar"}
              </Button>
            </div>
          </form>
